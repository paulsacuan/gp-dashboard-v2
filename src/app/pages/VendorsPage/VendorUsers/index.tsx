      ...
      <div className="w-full md:w-2/6 md:order-1 space-y-2">
        <Card className="hover:shadow-md p-4">
          ...
          <div className="flex flex-row justify-between gap-2 mt-4">
            ...
            <button
              onClick={() => {
                navigate(`/vendors/${vendor.id}/users/create`);
              }}
              className="relative inline-block px-4 py-2 font-bold group w-full"
            >
      ...
      <div className="w-full md:w-4/6">
        {users.data.data.data.length > 0 ? (
                    ...
                    >
                      <td className="py-2 px-4">
                        <Tooltip content="Edit User" className="text-xs">
                          <button
                            onClick={() =>
                              navigate(`/vendors/${vendor.id}/users/${user.id}`)
                            }
          ...
          <div className="flex items-center justify-center mt-[20%]">
            <div className="flex flex-col items-center justify-center gap-2 text-primary-200">
              <UserCircleIcon className="h-20 w-20" />
              <p className="font-light">
                This vendor has no users yet. Start adding now!
              </p>
            </div>
          </div>
        )}
